...
"""
Modified version of cpd_detector.py, by Li Ling (luxiya01), from smarc_perception.

This file is part of the porting process of slam_graph_slam_2.

At some point this should be moved to its own package...
"""
